        ...
        <div className="items">
            {isAdvertPage
                ...
                : <svg onClick={toggleButton} className={`w-[2.8vw] h-[5.2vh] cursor-pointer ${className}`} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    {isFavorite
                        ? <path d="M17 3H7C5.9 3 5.01 3.9 5.01 5L5 21L12 18L19 21V5C19 3.9 18.1 3 17 3Z" fill="gray" />
                        : <path d="M17 3H7C5.9 3 5 3.9 5 5V21L12 18L19 21V5C19 3.9 18.1 3 17 3ZM17 18L12 15.82L7 18V5H17V18Z" fill="gray" />}
                </svg>
            }
        </div>
    )
