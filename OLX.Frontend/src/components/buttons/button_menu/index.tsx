            ...
            <div className={`flex flex-col w-[95%] mx-auto gap-[2vh] button-menu-container z-0 ${open !== undefined ? !open ? 'close' : 'open' : ''}`}>
                ...
                {isComplete &&
                    <div className="bg-white/30 p-[10%] hover:bg-white/60 rounded-md" >
                        <svg className=" transition-all duration-300 ease-in-out hover:scale-[1.1] w-full h-auto cursor-pointer" onClick={onComplete} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
